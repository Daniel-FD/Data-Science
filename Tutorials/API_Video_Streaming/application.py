...
import time
# pip install flask numpy mediapipe matplotlib imutils IPython opencv-python
#  
# REF: https://towardsdatascience.com/how-to-display-video-streaming-from-a-webcam-using-flask-7a15e26fbab8
...
def gen(video):
    while True:
        ...
        image_enhanced = process_image(image)
        ret, jpeg = cv2.imencode('.jpg', image_enhanced)
        frame = jpeg.tobytes()
        yield (b'--frame\r\n'
